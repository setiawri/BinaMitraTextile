...
namespace BinaMitraTextile.Admin
{
    public partial class MasterData_v1_MoneyAccountCategoryAssignments_Form : LIBUtil.Desktop.Forms.MasterData_v1_Form
    {
        ...
        protected override void setupFields()
        {
            ...
            col_dgv_MoneyAccounts_Name = base.addColumn<DataGridViewTextBoxCell>(dgv, "col_dgv_MoneyAccounts_Name", iddl_MoneyAccounts_Id.LabelText, MoneyAccountCategoryAssignment.COL_MoneyAccounts_Name, true, true, "", true, false, 50, DataGridViewContentAlignment.MiddleLeft);
        ...
        protected override void populateInputFields()
        {
            ...
            iddl_MoneyAccounts_Id.SelectedValue = obj.MoneyAccounts_Id;
        ...
        {
            MoneyAccountCategoryAssignment.update(selectedRowID(), (Guid)iddl_MoneyAccountCategories.SelectedValue, (Guid)iddl_MoneyAccounts_Id.SelectedValue, itxt_Notes.ValueText);
        }

        protected override void add()
        {
            MoneyAccountCategoryAssignment.add((Guid)iddl_MoneyAccountCategories.SelectedValue, (Guid)iddl_MoneyAccounts_Id.SelectedValue, itxt_Notes.ValueText);
        }

        protected override bool isInputFieldsValid()
        {
            if (!iddl_MoneyAccounts_Id.hasSelectedValue())
            ...
            else if ((Mode != FormModes.Update && MoneyAccountCategoryAssignment.isExist(null, (Guid)iddl_MoneyAccountCategories.SelectedValue, (Guid)iddl_MoneyAccounts_Id.SelectedValue))
                || (Mode == FormModes.Update && MoneyAccountCategoryAssignment.isExist(selectedRowID(), (Guid)iddl_MoneyAccountCategories.SelectedValue, (Guid)iddl_MoneyAccounts_Id.SelectedValue)))

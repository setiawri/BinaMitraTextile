...
{
    public partial class MasterData_v2_FakturPajaks_Form : LIBUtil.Desktop.Forms.MasterData_v2_Form
    {
        /*******************************************************************************************************/
        #region SETTINGS
        ...
        public MasterData_v2_FakturPajaks_Form() : this(FormModes.Add) { }
        public MasterData_v2_FakturPajaks_Form(FormModes startingMode) : base(startingMode, FORM_SHOWDATAONLOAD) { InitializeComponent(); }

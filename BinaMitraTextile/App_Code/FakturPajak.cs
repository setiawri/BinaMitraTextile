...
namespace BinaMitraTextile
{
    public class FakturPajak
    {
        ...
        public FakturPajak(Guid? id)
        {
            ...
            {
                Id = (Guid)id;
                DataRow row = Util.getFirstRow(get(Id, null, null, null, null, false));
        ...
        public static Guid add(DateTime Timestamp, Guid Customers_Id, string No, decimal DPP, decimal PPN, string Notes)
        {
        ...
        public static DataTable get(Guid? Id, string No, Guid? Customers_Id, DateTime? StartDate, DateTime? EndDate, bool showCompleted)
        {
            SqlQueryResult result = DBConnection.query(
                false,
                DBUtil.ActiveSqlConnection,
        ...
        public static void update(Guid Id, DateTime Timestamp, Guid Customers_Id, string No, decimal DPP, decimal PPN, string Notes)
        {

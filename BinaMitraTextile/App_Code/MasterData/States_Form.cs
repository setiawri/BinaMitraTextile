...
{
    public class States_Form : MasterData_v1_Form
    {
        /*******************************************************************************************************/
        #region SETTINGS

        private const string FORM_TITLE = "STATES";
        ...
        public States_Form(FormMode startingMode)
        ...
        protected override void setupFields()
        {
            ...
            col_grid_name.DataPropertyName = State.COL_DB_NAME; //set field's data property name in gridview
        ...
        {
            return State.getByFilter(chkIncludeInactive.Checked, _inputTxtName.TextValue).DefaultView;
        }
        
        protected override void populateInputFields()
        {
            State obj = new State(selectedRowID());
            _inputTxtName.TextValue = obj.Name;
        }

        protected override void update()
        {
            State.update(selectedRowID(), _inputTxtName.TextValue);
        }

        protected override void add()
        {
            State.add(_inputTxtName.TextValue);
        }
        ...
        protected override Boolean isInputFieldsValid()
        {
            ...
            else if ((Mode != FormMode.Update && State.isNameExist(_inputTxtName.TextValue, null))
                || (Mode == FormMode.Update && State.isNameExist(_inputTxtName.TextValue, selectedRowID())))
        ...
        {
            State.updateActiveStatus(id, activeStatus);
        }

        protected override void updateDefaultRow(Guid id)
        {
            State.updateDefaultRow(id);
        }

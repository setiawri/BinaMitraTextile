...
{
    public class ProfitLossStatementsController : Controller
    {
        ...
        {
            if (!UsersController.getUserAccess(Session).ProfitLossStatements_View)
            ...
            {
                List<ProfitLossStatementsModel> models = get(null, FILTER_chkDateFrom, FILTER_DateFrom, FILTER_chkDateTo, FILTER_DateTo);
                return View(models);
            }
        }
        ...
        public static ProfitLossStatementsModel get(bool? FILTER_chkDateFrom, DateTime? FILTER_DateFrom, bool? FILTER_chkDateTo, DateTime? FILTER_DateTo) { return get(null, FILTER_chkDateFrom, FILTER_DateFrom, FILTER_chkDateTo, FILTER_DateTo).FirstOrDefault(); }
        public static List<ProfitLossStatementsModel> get(Guid? Id, 
            bool? FILTER_chkDateFrom, DateTime? FILTER_DateFrom, bool? FILTER_chkDateTo, DateTime? FILTER_DateTo)
        {
            ...
            string sql = getSQL();
            return new DBContext().Database.SqlQuery<ProfitLossStatementsModel>(getSQL(),
                    DBConnection.getSqlParameter(ProfitLossStatementsModel.COL_Id.Name, Id),
        ...
        public static string getSQL()
        {
            ...
            sql_SalesSellValue(ref sqlStatements, ref sqlVariables);
            sql_Additional(ref sqlStatements, ref sqlVariables);
            ...
            return string.Format(@"
				...
				", sqlStatements, sqlVariables);          
        }

        /******************************************************************************************************************************************************/

        public static void sql_SalesSellValue(ref string sql, ref string variables)
        {
            sql += @"
        ...
        public static void sql_Additional(ref string sqlStatements, ref string sqlVariables)
        {
            sqlStatements += @"
...
--        WHERE Sales.time_stamp < @PeriodEnd
        ...
        WHERE RevenuesAndExpenses.Timestamp >= @PeriodStart
            ...
            sqlVariables += Util.append(sqlVariables, @"

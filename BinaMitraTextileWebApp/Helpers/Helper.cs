...
namespace BinaMitraTextileWebApp
{
    ...
    public class Helper
    {
        ...
        public const string APP_VERSION = "v22031501";
        ...
        private const string SERVERNAME_LIVE = @"BM\SQLEXPRESS";
        private const string DBNAME = "BinaMitraTextile";
        private const string USERID = "binamitra";
        private const string PASSWORD = "binamitra";
